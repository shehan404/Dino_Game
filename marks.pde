class Marks{
  ...
  if(score>1){zero="0000 ";
    if(score>10){zero="000  ";
      if(score>100){zero="00   ";
        if(score>1000){zero="0    ";
           if(score>10000){zero="     ";
          }
         }  
       }
 ...
 text("   "+hzero,width-170, marksY);
  if(highscore>1){hzero="0000 ";
    if(highscore>10){hzero="000  ";
      if(highscore>100){hzero="00   ";
        if(highscore>1000){hzero="0    ";
           if(highscore>10000){hzero="     ";
           }
         }  
       }
     }
